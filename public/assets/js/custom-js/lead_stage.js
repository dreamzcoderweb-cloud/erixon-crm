                    ...
                    return `
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item btn-edit-stage" href="javascript:void(0);" data-id="${row.lead_stage_id}">
                                    <i class="bx bx-edit-alt me-1"></i> Edit
                                </a>
                                <a class="dropdown-item text-danger btn-delete-stage" href="javascript:void(0);" data-id="${row.lead_stage_id}" data-name="${row.name}">
