    ...
    let requirementTable = $('#lead-requirements-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `
                        <button class="btn btn-sm btn-outline-primary btn-edit-requirement me-1" data-id="${row.lead_requirements_id}">
                            <i class="bx bx-edit-alt"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger btn-delete-requirement" data-id="${row.lead_requirements_id}" data-name="${row.name}">
